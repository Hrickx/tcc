...
--
-- Host: 127.0.0.1
-- Tempo de geração: 28/01/2026 às 08:51
...
(40, 3, 'SAIDA', 4, '2026-01-27'),
(41, 6, 'ENTRADA', 4, '2026-01-27'),
(43, 10, 'ENTRADA', 22, '2026-01-28'),
(44, 2, 'SAIDA', 3, '2026-01-28'),
(45, 2, 'SAIDA', 1, '2026-01-28');
...
(18, 27, '', 0.00, '2026-01-27 23:04:46'),
(19, 28, 'DINHEIRO', 0.00, '2026-01-28 03:36:51'),
(20, 29, 'DINHEIRO', 0.00, '2026-01-28 03:48:45');
...
(10, 'Banco Corsa', '', 130.00, 120.00, 1);
...
(63, 4, 14, 3, 4, 30.00, 120.00, '2026-01-27', 'APROVADO', NULL, ''),
(65, 3, 14, 2, 1, 315.00, 315.00, '2026-01-27', 'APROVADO', NULL, ''),
(66, 4, 14, 2, 5, 30.00, 150.00, '2026-01-27', 'APROVADO', NULL, ''),
(67, 5, 10, 1, 10, 90.00, 900.00, '2026-01-27', 'APROVADO', NULL, ''),
(68, 4, 14, 3, 13, 30.00, 390.00, '2026-01-27', 'APROVADO', NULL, ''),
(69, 6, 14, 3, 3, 200.00, 600.00, '2026-01-27', 'APROVADO', NULL, ''),
(70, 6, 14, 2, 4, 200.00, 800.00, '2026-01-27', '', NULL, ''),
(71, 4, 10, 2, 5, 30.00, 150.00, '2026-01-27', 'APROVADO', NULL, ''),
(72, 8, 12, 2, 3, 200.00, 600.00, '2026-01-27', 'REJEITADO', NULL, 'Fornecedor'),
(73, 8, 14, 1, 5, 200.00, 1000.00, '2026-01-27', 'APROVADO', NULL, ''),
(74, 8, 14, 1, 1, 200.00, 200.00, '2026-01-27', 'REJEITADO', NULL, 'Não'),
(75, 3, 14, 2, 3, 315.00, 945.00, '2026-01-28', 'APROVADO', NULL, ''),
(76, 8, 14, 3, 3, 200.00, 600.00, '2026-01-28', 'REJEITADO', NULL, 'Não'),
(77, 4, 14, 2, 1, 30.00, 30.00, '2026-01-28', 'REJEITADO', NULL, 'Não'),
(78, 8, 14, 2, 2, 200.00, 400.00, '2026-01-28', 'REJEITADO', NULL, 'fornecedor '),
(79, 10, 14, 2, 3, 120.00, 360.00, '2026-01-28', 'APROVADO', NULL, ''),
(80, 10, 14, 2, 4, 120.00, 480.00, '2026-01-28', 'APROVADO', NULL, ''),
(81, 10, 14, 1, 2, 120.00, 240.00, '2026-01-28', 'PENDENTE', NULL, '');
...
(10, 'Henrique', 'henrique@auto.com', '$2y$10$uqGiAaPcmg3C/46fNS9z.ONR8p37Gs0jojt6Ujf0emeoJIE4Y9l/W', 'GERENTE', 'ATIVO', 0),
(11, 'Eduarda', 'Eduarda.venda@auto.com', '$2y$10$O4AtCYgPg2DdfQCWspk81OOI3PSa0H0F8DpWM75QD0meVVTyjOLvq', 'VENDEDOR', 'INATIVO', 10),
...
(18, 'Emilio', 'emilio@auto.com', '$2y$10$7HCPj/CT1tKSoGJ5P8SpNu0.wsd3BYCDX1M3UeN9NhnEr1v26.Qqa', 'ESTOQUISTA', 'INATIVO', 0);
...
(27, 12, '2026-01-27', 494.00, 26.00, 'FINALIZADA'),
(28, 10, '2026-01-28', 342.00, 18.00, 'FINALIZADA'),
(29, 12, '2026-01-28', 114.00, 6.00, 'FINALIZADA');
...
--
ALTER TABLE `movimentacao_estoque`
  MODIFY `id_movimentacao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
...
--
ALTER TABLE `pecas`
  MODIFY `id_peca` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
